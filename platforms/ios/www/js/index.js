...
function homeSliderData(data) {
    for (var i = 0; i < data.homeslider.length; i++) {
        ...
        if (price_type == "Dollares") {
            var prize = "$ " + data.homeslider[i].prize;
        } else {
            var prize = "₡ " + data.homeslider[i].prize;
        }
        ...
        if (variable_type == "car") {
            $("#owl-demo").append('<div class="item"><a href=' + "javascript:void(0);" + ' onclick=' + "goToProductDetail('" + escape(variable_type) + "','" + escape(pro_id) + "');" + '><img src="' + file_img + '"><div class="for_slider_txt"><div class="slider_title">' + title + '</div><div class="slider_price">' + prize + '</div><div class="slider_address">' + address + '</div><div class="icon-area"><div class="rating-area"><div class="rating-txt"><img src="images/star.png" class="star-img">' + rating + ' /10</div> </div><div class="clearfix"> </div><ul class="list-inline icon-list">' + fuelli + exchangeli + loanli + transmissionli + absli + '<li><img src="images/fourwheel.png" class="icon-img" title="Four Wheel Drive"></li>' + rtvli + xenon_ledli + '</ul></div></div></a></div>');
        }
        if (variable_type == "realestate") {
            $("#owl-demo2").append('<div class="item"><a href=' + "javascript:void(0);" + ' onclick=' + "goToProductDetail('" + escape(variable_type) + "','" + escape(pro_id) + "');" + '><img src="' + file_img + '"><div class="for_slider_txt"><div class="slider_title">' + title + '</div><div class="slider_price">' + prize + '</div><div class="slider_address">' + address + '</div><div class="icon-area"><div class="rating-area"><div class="rating-txt"><img src="images/star.png" class="star-img">' + rating + ' /10</div> </div><div class="clearfix"></div><ul class="list-inline icon-list">' + exchangeli + loanli + electricityli + waterli + '</ul></div></div></a></div></a></div>');
        }
        if (variable_type == "other") {
            $("#owl-demo3").append('<div class="item"><a href=' + "javascript:void(0);" + ' onclick=' + "goToProductDetail('" + escape(variable_type) + "','" + escape(pro_id) + "');" + '><img src="' + file_img + '"><div class="for_slider_txt"><div class="slider_title">' + title + '</div><div class="slider_price">' + prize + '</div><div class="slider_address">' + address + '</div><div class="icon-area"><div class="rating-area"><div class="rating-txt"><img src="images/star.png" class="star-img">' + rating + ' /10</div> </div><div class="clearfix"></div><ul class="list-inline icon-list">' + exchangeli + loanli + '</ul></div></div></a></div></a></div>');
        }
